        ...
        <section id="how-it-works" className="py-24 bg-[#0A0A0F] relative">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                    ...
                    <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-px bg-gradient-to-r from-transparent via-[#6366F1]/30 to-transparent border-t border-dashed border-[#6366F1]/30 z-0" />
                    ...
                    {[
                        ...
                        <div key={i} className="relative z-10 flex flex-col items-center text-center">
                            <div className="w-24 h-24 rounded-full bg-[#0A0A0F] border-4 border-[#12121A] flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                                <span className="text-3xl font-black text-[#6366F1]">{item.step}</span>
                            </div>
